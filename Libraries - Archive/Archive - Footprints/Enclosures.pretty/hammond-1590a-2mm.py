...
screw_h_len = 82.60  # Top view of assembly
screw_v_len = 28.50  # Top view of assembly
inner_h_len = 76.60  # Top view looking inside box - Datasheet: 76.65, changed 76.60 to align ok.
inner_v_len = 22.50  # Top view looking inside box
outer_h_len = 89.10  # Top view looking inside box
outer_v_len = 35.00  # Top view looking inside box
...
# Module info
modulename = "Hammond_1590A_2mm_python"
tags = "Hammond_1590A_2mm_python"
value = "Hammond_1590A_2mm_python"
description = "Hammond_1590A_2mm_python"
reference = "REF**"
...
with open( modulename + '.kicad_mod', 'a') as the_file:
    ...
    moduleinfo = """(module Hammond_1590A_2mm_python (layer F.Cu) (tedit 56C35386)
  (descr Hammond_1590A_2mm_python)
  (tags Hammond_1590A_2mm_python)
  (fp_text reference REF** (at -0.05 1.35) (layer F.SilkS)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text value Hammond_1590A_2mm_python (at -0.05 -1.15) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )"""
