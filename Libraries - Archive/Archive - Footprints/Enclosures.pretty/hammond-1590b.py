...
# Module info
modulename = "Hammond_1590B_python"

# These are not yet incorporated 
tags = "Hammond_1590B_python"
value = "Hammond_1590B_python"
description = "Hammond_1590B_python"
reference = "REF**"
...
with open( modulename + '.kicad_mod', 'a') as the_file:
    ...
    moduleinfo = """(module Hammond_1590B_python (layer F.Cu) (tedit 56C35386)
  (descr Hammond_1590B_python)
  (tags Hammond_1590B_python)
  (fp_text reference REF** (at -0.05 1.35) (layer F.SilkS)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text value Hammond_1590B_python (at -0.05 -1.15) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )"""
