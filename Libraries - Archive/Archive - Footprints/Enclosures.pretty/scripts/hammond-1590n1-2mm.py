...
screw_h_len = 110.0  # Top view of assembly
screw_v_len = 55.5  # Top view of assembly
inner_h_len = 104.0  # Top view looking inside box  Datasheet 104.1
inner_v_len = 49.0  # Top view looking inside box
outer_h_len = 117.0  # Top view looking inside box - Datasheet 117.7
outer_v_len = 62.0  # Top view looking inside box
...
# Module info
modulename = "Hammond_1590N1_2mm_python"

# These are not yet incorporated 
tags = "Hammond_1590N1_2mm_python"
value = "Hammond_1590N1_2mm_python"
description = "Hammond_1590N1_2mm_python"
reference = "REF**"
...
with open( modulename + '.kicad_mod', 'a') as the_file:
    ...
    moduleinfo = """(module Hammond_1590N1_2mm_python (layer F.Cu) (tedit 56C35386)
  (descr Hammond_1590N1_2mm_python)
  (tags Hammond_1590N1_2mm_python)
  (fp_text reference REF** (at -0.05 1.35) (layer F.SilkS)
    (effects (font (size 1 1) (thickness 0.15)))
  )
  (fp_text value Hammond_1590N1_2mm_python (at -0.05 -1.15) (layer F.Fab)
    (effects (font (size 1 1) (thickness 0.15)))
  )"""
